...
$query = mysqli_query($conn, "SELECT * FROM more WHERE id='$id'");
        ...
        <div class="col-12 col-md-6 mb-5">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-between mt-3">
                    ...
                    <button type="submit" class="btn btn-primary" name="kembali"><a href="more.php">Kembali</a></button>
            ...
            <?php
                if(isset($_POST['simpan'])){
                    ...
                    if ($image != "") {
                        ...
                        if (in_array($ekstensi, $ekstensi_berhasil) === true) {
                            ...
                            $query = mysqli_query($conn, "UPDATE more SET nama='$nama', unduhan='$unduhan', genre='$genre', rilis='$rilis', link='$link', image='$new_name' WHERE id='$id'");
                        ...
                        $query = mysqli_query($conn, "UPDATE more SET nama='$nama', unduhan='$unduhan', genre='$genre', rilis='$rilis', link='$link' WHERE id='$id'");
                ...
                if(isset($_POST['hapus'])){
                    // Hapus sementara
                    $queryHapus = mysqli_query($conn, "UPDATE more SET is_deleted = 1 WHERE id='$id'");
                    
                    if(!$queryHapus){
                        die("Query Error : " . mysqli_errno($conn) . "-" . mysqli_error($conn));
                    } else {
                        echo "<script>alert('Data berhasil dihapus sementara!');</script>";
                        ?>
                        <meta http-equiv="refresh" content="2, url=more.php" />
                        <?php
                    }
