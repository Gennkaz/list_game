...
$query = mysqli_query($conn, "SELECT * FROM top2 WHERE id='$id'");
        ...
        <div class="col-12 col-md-6 mb-5">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-between mt-3">
                    ...
                    <button type="submit" class="btn btn-primary" name="kembali"><a href="top2.php">Kembali</a></button>
            ...
            <?php
                if(isset($_POST['simpan'])){
                    ...
                    if ($image != "") {
                        ...
                        if (in_array($ekstensi, $ekstensi_berhasil) === true) {
                            ...
                            $query = mysqli_query($conn, "UPDATE top2 SET nama='$nama', unduhan='$unduhan', genre='$genre', rilis='$rilis', rating='$rating', link='$link', image='$new_name' WHERE id='$id'");
                            ...
                            if (!$query) {
                                ...
                                ?>
                                    <meta http-equiv="refresh" content="2, url=top2.php" />
                                <?php
                            }
                        } else {
                        ...
                        $query = mysqli_query($conn, "UPDATE top2 SET nama='$nama', unduhan='$unduhan', genre='$genre', rilis='$rilis', rating='$rating', link='$link' WHERE id='$id'");
                ...
                if(isset($_POST['hapus'])){
                    $queryHapus = mysqli_query($conn, "DELETE FROM top2 WHERE id='$id'");
