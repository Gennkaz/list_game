...
$jumlahTop = mysqli_num_rows($top2);
?>
            ...
            if (isset($_POST['simpan'])) {
                ...
                if ($image != "") {
                    ...
                    if (in_array($ekstensi, $ekstensi_berhasil) === true) {
                        ...
                        $query = mysqli_query($conn, "INSERT INTO top2 (nama, unduhan, genre, rilis, rating, link, image) VALUES ('$nama', '$unduhan', '$genre', '$rilis', '$rating', '$link', '$new_name')");
                    ...
                    $query = mysqli_query($conn, "INSERT INTO top2 (nama, unduhan, genre, rilis, link) VALUES ('$nama', '$unduhan', '$genre', '$rilis', '$rating', '$link')");
            ...
            <div class="table-responsive mt-5">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td colspan="8" class="text-center">List Game Top 5-10 Tidak Tersedia!</td>
                            </tr>
                            <?php
                        } else {
                            $jumlah = 1;
                            while ($data = mysqli_fetch_array($top2)) {
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="top2-detail.php?id=<?php echo $data['id']; ?>"
